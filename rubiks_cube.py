...
class rubiks_cube():
    def __init__(self, root):
        ...
        self.reset_button = menu_button(self.menu_background, "reset", "Arial 25 bold", "white", "black", self.menu_background_width / 2, 40, self.reset_cube_event).button
        self.show_instructions_button = menu_button(self.menu_background, "instructions", "Arial 25 bold", "white", "black", self.menu_background_width / 2, 80, self.show_instructions).button
        
        scramble_cube_menu_cors = [self.menu_background_width / 2, 150]
        ...
        self.moves_speed_label = menu_label(self.menu_background, "moves speed (sec)", "Arial 18 bold", "red", "black", scramble_cube_menu_cors[0] - 30, scramble_cube_menu_cors[1] + 60).label
        self.moves_speed_label2 = menu_label(self.menu_background, ":", "Arial 18 bold", "red", "black", scramble_cube_menu_cors[0] + 90, scramble_cube_menu_cors[1] + 60).label
        self.moves_speed_button = menu_button(self.menu_background, self.moves_speed, "Arial 20 bold", "white", "black", scramble_cube_menu_cors[0] + 125, scramble_cube_menu_cors[1] + 60, self.change_game_settings).button
        self.moves_number_label = menu_label(self.menu_background, "moves number", "Arial 18 bold", "red", "black", scramble_cube_menu_cors[0] - 30, scramble_cube_menu_cors[1] + 100).label
        self.moves_number_label2 = menu_label(self.menu_background, ":", "Arial 18 bold", "red", "black", scramble_cube_menu_cors[0] + 70, scramble_cube_menu_cors[1] + 100).label
        self.moves_number_button = menu_button(self.menu_background, self.scramble_moves, "Arial 20 bold", "white", "black", scramble_cube_menu_cors[0] + 110, scramble_cube_menu_cors[1] + 100, self.change_game_settings).button
        self.scramble_button = menu_button(self.menu_background, "scramble", "Arial 25 bold", "white", "black", scramble_cube_menu_cors[0], scramble_cube_menu_cors[1] + 150, self.scramble_cube_event).button
        ...
        self.cube_size_label = menu_label(self.menu_background, "cube size", "Arial 18 bold", "red", "black", cube_graphics_menu_cors[0] - 40, cube_graphics_menu_cors[1] + 60).label
        self.cube_size_label2 = menu_label(self.menu_background, ":", "Arial 18 bold", "red", "black", cube_graphics_menu_cors[0] + 30, cube_graphics_menu_cors[1] + 60).label
        self.cube_size_button = menu_button(self.menu_background, self.square_side_length, "Arial 20 bold", "white", "black", cube_graphics_menu_cors[0] + 80, cube_graphics_menu_cors[1] + 60, self.change_game_settings).button
        self.sides_distortion_label = menu_label(self.menu_background, "sides distortion", "Arial 18 bold", "red", "black", cube_graphics_menu_cors[0] - 40, cube_graphics_menu_cors[1] + 100).label
        self.sides_distortion_label2 = menu_label(self.menu_background, ":", "Arial 18 bold", "red", "black", cube_graphics_menu_cors[0] + 65, cube_graphics_menu_cors[1] + 100).label
        self.sides_distortion_button = menu_button(self.menu_background, self.sides_distortion, "Arial 20 bold", "white", "black", cube_graphics_menu_cors[0] + 110, cube_graphics_menu_cors[1] + 100, self.change_game_settings).button
        self.borders_width_label = menu_label(self.menu_background, "borders width", "Arial 18 bold", "red", "black", cube_graphics_menu_cors[0] - 30, cube_graphics_menu_cors[1] + 140).label
        self.borders_width_label2 = menu_label(self.menu_background, ":", "Arial 18 bold", "red", "black", cube_graphics_menu_cors[0] + 65, cube_graphics_menu_cors[1] + 140).label
        self.borders_width_button = menu_button(self.menu_background, self.borders_width, "Arial 20 bold", "white", "black", cube_graphics_menu_cors[0] + 100, cube_graphics_menu_cors[1] + 140, self.change_game_settings).button
    ...
    def show_instructions(self, event = None):
        self.picture_choice = Image.open(os.getcwd() + "/rubiks_cube_notation.jpg")
        self.picture_choice = self.picture_choice.resize((int(self.cube_background_width), int(self.cube_background_width * self.picture_choice.height / self.picture_choice.width)), Image.ANTIALIAS)
        self.picture_choice = ImageTk.PhotoImage(self.picture_choice)
        # self.picture_choice_spot = tk.Canvas(self.cube_background, width = self.picture_choice.width(), height = self.picture_choice.height())
        # self.picture_choice_spot.grid(row = 0, column = 0, sticky = tk.NSEW)
        self.cube_background.create_image(self.picture_choice.width() / 2, self.picture_choice.height() / 2, image = self.picture_choice)
    ...
    def draw_cube_side(self, background, cube_face_oriented, borders_width, piece_left_side_length, piece_down_side_length, piece_left_side_angle, piece_down_side_angle, cube_face_down_left_point):
        ...
        cfdl2 = cfdl; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[2][0], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "down_left_piece")
        cfdl2 = [cfdl[0] + ps2 * math.cos(pa2), cfdl[1] - ps2 * math.sin(pa2)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[2][1], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "down_middle_piece")
        cfdl2 = [cfdl[0] + 2 * ps2 * math.cos(pa2), cfdl[1] - 2 * ps2 * math.sin(pa2)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[2][2], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "down_right_piece")
        cfdl2 = [cfdl[0] + ps1 * math.cos(pa1), cfdl[1] - ps1 * math.sin(pa1)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[1][0], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "left_middle_piece")
        cfdl2 = [cfdl[0] + ps1 * math.cos(pa1) + ps2 * math.cos(pa2), cfdl[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[1][1], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "centre_piece")
        cfdl2 = [cfdl[0] + ps1 * math.cos(pa1) + 2 * ps2 * math.cos(pa2), cfdl[1] - ps1 * math.sin(pa1) - 2 * ps2 * math.sin(pa2)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[1][2], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "right_middle_piece")
        cfdl2 = [cfdl[0] + 2 * ps1 * math.cos(pa1), cfdl[1] - 2 * ps1 * math.sin(pa1)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[0][0], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "up_left_piece")
        cfdl2 = [cfdl[0] + 2 * ps1 * math.cos(pa1) + ps2 * math.cos(pa2), cfdl[1] - 2 * ps1 * math.sin(pa1) - ps2 * math.sin(pa2)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[0][1], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "up_middle_piece")
        cfdl2 = [cfdl[0] + 2 * ps1 * math.cos(pa1) + 2 * ps2 * math.cos(pa2), cfdl[1] - 2 * ps1 * math.sin(pa1) - 2 * ps2 * math.sin(pa2)]; background.create_polygon([cfdl2[0], cfdl2[1], cfdl2[0] + ps2 * math.cos(pa2), cfdl2[1] - ps2 * math.sin(pa2), cfdl2[0] + ps2 * math.cos(pa2) + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1) - ps2 * math.sin(pa2), cfdl2[0] + ps1 * math.cos(pa1), cfdl2[1] - ps1 * math.sin(pa1)], fill = cf_colors[0][2], activefill = self.activefill_color, width = borders_width, outline = "black", tags = "up_right_piece")
    def make_move_graphic(self, event = None):
        ...
        self.cube_background.create_text(self.front_cube_side_centre_point[0] - 3 * self.square_side_length * (1/ 2 - self.sides_distortion / math.sqrt(2)) + 10, self.front_cube_side_centre_point[1] - 3 * self.square_side_length * (1/ 2 + self.sides_distortion / math.sqrt(2)) - 60, text = "z", font = "Times 20 bold", fill = "black", activefill = "purple")
